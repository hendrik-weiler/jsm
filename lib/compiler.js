...
exports.jsmWatch = function() {
  ...
  if (fs.existsSync( cwd + '/jsm.ini' )) {
    ...
    console.log('Reading folder ' + cwd + '/' + project.appFolder + ' ...');
    watch.watchTree(cwd + '/' + project.appFolder, function (f, curr, prev) {
      if (typeof f == "object" && prev === null && curr === null) {
        console.log('Started watching ' + cwd + '/' + project.appFolder);
      } else if (prev === null) {
        // f is a new file
        build(cwd,project);
